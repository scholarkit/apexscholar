            ...
            {!selectedChatId ? (
              <div className="h-full flex flex-col items-center justify-center text-center max-w-sm mx-auto opacity-70">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Select a conversation or create a new one to start interacting with your
                  personalized research brain.
                </p>
              </div>
            ) : loadingMessages ? (
              <div className="h-full flex flex-col items-center justify-center gap-4">
                <Loader2 className="w-8 h-8 text-indigo-500 animate-spin" />
                <span className="text-sm text-zinc-500 animate-pulse tracking-widest uppercase">
