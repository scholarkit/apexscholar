...
export const exploreService = {
  ...
  async createInsight(
    insight: Omit<PaperInsight, 'id' | 'created_at' | 'updated_at'>,
    projectId?: string
  ...
  async upsertNode(
    node: Omit<KGNode, 'id' | 'created_at' | 'updated_at'>,
    projectId?: string
  ): Promise<KGNode> {
    if (provider === 'supabase') {
  ...
  async upsertEdge(
    edge: Omit<KGEdge, 'id' | 'created_at' | 'updated_at'>,
    projectId?: string
  ): Promise<KGEdge> {
    if (provider === 'supabase') {
