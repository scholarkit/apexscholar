import { BookOpen, Code2, Coffee, CreditCard, Globe, Heart, Mail, Sparkles } from 'lucide-react';

export default function About() {
  return (
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-8 animate-in fade-in duration-500 pb-32 sm:pb-8">
      {/* Header */}
      <header className="text-center space-y-4 pt-12 pb-6 border-b    border-[var(--color-border)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-[var(--color-surface)]/40 border    border-[var(--color-border)] rounded-xl p-4 sm:p-8 space-y-4 hover:border-[var(--color-border)] transition-colors">
          ...
          <div className="space-y-4 text-zinc-300 leading-relaxed text-sm lg:text-base">
            <p>
              Academic tools are often scattered, outdated, or prohibitively expensive. Researchers
              waste countless hours juggling PDFs, formatting citations, and switching between
              completely disconnected applications.
            </p>
            <p>
              <strong>Apex Scholar</strong> is my attempt to fix that. I wanted to build a single,
              beautiful, cohesive workspace that leverages modern web technologies and AI.
            </p>
            <p>
              By keeping it open and running mostly local/browser-first (via Puter.js), your data
              remains yours, and the friction of discovery, writing, and analysis is dramatically
              reduced.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[var(--color-surface)]/40 border    border-[var(--color-border)] rounded-xl p-4 sm:p-8 space-y-4 hover:border-[var(--color-border)] transition-colors">
          ...
          <div className="space-y-4 text-zinc-300 leading-relaxed text-sm lg:text-base">
            <p>
              I'm an independent developer and a research enthusiast who believes that better tools
              lead to better science and accelerated human progress.
            </p>
            <p>
              I spend my nights and weekends designing and coding applications that solve real-world
              frustrations. When I'm not writing code, I'm usually reading papers, exploring new web
              architectures, or drinking absurd amounts of coffee.
            </p>
      ...
      <section className="bg-indigo-950/20 border border-indigo-500/20 rounded-xl p-4 sm:p-8 md:p-12 text-center mt-12">
        ...
        <p className="text-indigo-200/80 max-w-2xl mx-auto mb-10 leading-relaxed">
          This project is and will remain free to use. If you find it valuable for your research
          workflow, consider supporting its continued development, server costs, and open-source
          maintenance. There are a few ways to help:
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <a
            ...
            className="group flex flex-col items-center p-6 bg-[var(--color-surface)] border    border-[var(--color-border)] hover:border-[#FFDD00]/50 rounded-xl transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#FFDD00]/10"
          >
            ...
            <p className="text-xs text-zinc-400">
              Coffee fuels code. Global support via card or PayPal.
            </p>
          </a>

          {/* UPI */}
          <button
            onClick={() => alert('UPI ID: kywagle@okaxis')}
            className="group flex flex-col items-center p-6 bg-[var(--color-surface)] border    border-[var(--color-border)] hover:border-emerald-500/50 rounded-xl transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/10 text-left"
          >
            <div className="w-12 h-12 bg-emerald-500/10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              ...
              <span className="text-emerald-400 font-bold text-lg leading-none tracking-tighter">
                UPI
              </span>
            </div>
            <h3 className="text-white font-semibold mb-1 w-full text-center">UPI Transfer</h3>
            <p className="text-xs text-zinc-400 text-center">
              Fast, zero-fee direct support for users in India.
            </p>
          </button>

          {/* Razorpay */}
          {/* <a href="#" className="group flex flex-col items-center p-6 bg-[var(--color-surface)] border    border-[var(--color-border)] hover:border-[#0288D1]/50 rounded-xl transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#0288D1]/10">
