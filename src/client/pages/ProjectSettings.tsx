    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className={`font-semibold ${danger ? 'text-red-300' : 'text-white'}`}>{title}</h3>
            ...
            <div>
              ...
              <div className="relative w-full sm:w-64">
                ...
                <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none flex items-center gap-2">
                  <span
                    className={`w-2 h-2 rounded-full ${STATUS_OPTIONS.find((o) => o.value === status)?.dot}`}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4 p-4 rounded-xl bg-red-500/5 border border-red-500/20 animate-in zoom-in-95 duration-200">
            <div className="flex items-start gap-2 text-sm text-red-300">
              ...
              <p>
                ...
                <strong className="font-mono text-white">{activeProject.name}</strong> to confirm
                deletion.
              </p>
            </div>
            <input
