            ...
            <div className="bg-zinc-900/40 border border-[#1f2937] rounded-2xl p-6 sm:p-8">
                ...
                {nextLesson && (
                    <button
                        ...
                        className="mt-5 inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-500 hover:bg-indigo-400 text-white text-sm font-medium rounded-xl transition-colors shadow-lg shadow-indigo-500/20"
                    >
