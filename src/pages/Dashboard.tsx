...
export default function Dashboard() {
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="mt-8">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="p-5 rounded-xl bg-zinc-900/30 border border-white/5 h-28 animate-pulse"></div>
            ))}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* KPI Overview */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-3 sm:p-6 rounded-2xl bg-zinc-900/50 border border-white/5 backdrop-blur-sm">
          <div className="flex items-center gap-4 mb-4">
        ...
        <div className="space-y-4">
            ...
            <div key={entry.id} className="p-5 rounded-xl bg-zinc-900/30 border border-white/5 hover:bg-zinc-900/50 transition-colors group">
              <div className="flex justify-between items-start mb-2">
                <div className="flex items-center gap-3">
                  <span className="px-1 sm:px-2.5 py-1 rounded-md bg-zinc-800 text-xs font-medium text-zinc-300 border border-white/5">
                    {entry.entry_type}
                  </span>
          ...
          {entries.length === 0 && (
            <div className="text-center py-12 bg-zinc-900/20 border border-dashed border-white/10 rounded-2xl">
              ...
              <Link to="/journal" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600/10 text-indigo-400 hover:bg-indigo-600/20 border border-indigo-500/20 rounded-xl font-medium transition-colors">
